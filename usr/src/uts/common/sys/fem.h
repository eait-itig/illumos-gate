...
struct fem_list {
	 ...
	 * will be copied instead), but it CAN be added to, and femh_lock
	 * protects feml_tos against partial increment (or increment before the
	 * new feml_nodes[] entry is fully written).
	 */
