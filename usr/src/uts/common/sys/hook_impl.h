...
struct hook_family_int;
struct hook_stack;

typedef struct hook_int hook_int_t;
typedef struct hook_notify hook_notify_t;
typedef struct hook_event_int hook_event_int_t;
typedef struct hook_family_int hook_family_int_t;
...
struct hook_event_int {
	krwlock_t			hei_lock;
	list_node_t			hei_node;
	hook_event_t			*hei_event;
	list_t				hei_head;	/* hook_int_t */
	kstat_t				*hei_kstatp;
	hook_event_kstat_t		hei_kstats;
	list_t				hei_nhead;	/* hook_notify_t */
...
struct hook_family_int {
	krwlock_t			hfi_lock;
	list_node_t			hfi_node;
	list_t				hfi_head;	/* hook_event_int_t */
	hook_family_t			hfi_family;
	kstat_t				*hfi_kstat;
	struct hook_stack		*hfi_stack;
	list_t				hfi_nhead;	/* hook_notify_t */
...
struct hook_stack {
	krwlock_t			hks_lock;
	list_node_t			hks_node;
	list_t				hks_familylist;	/* hook_family_int_t */
	netstack_t			*hks_netstack;
	netstackid_t			hks_netstackid;
	list_t				hks_nhead;	/* hook_notify_t */
	int				hks_shutdown;
